/*
package tk.taxhidinkadiri.myapplication.other_methods.Main_Screen.data;
...
import tk.taxhidinkadiri.myapplication.other_methods.Main_Screen.Util.Util;
...
/*
    ...
    public void addContact(Contact contact) {
        ...
        values.put(Util.KEY_MASS, contact.getMass());
        values.put(Util.KEY_HEIGHT, contact.getHeight());
    ...
    public Contact getContact(int id) {
        ...
        contact.setHeight(cursor.getString(2));
        contact.setMass(cursor.getString(3));
